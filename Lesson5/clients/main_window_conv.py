...
# Form implementation generated from reading ui file 'c:\YandexDisk\Education\GeekBrains\Messenger_PyQ\Lesson5\clients\client.ui'
#
...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.label_message_quantities = QtWidgets.QLabel(self.centralwidget)
        self.label_message_quantities.setEnabled(True)
        self.label_message_quantities.setGeometry(QtCore.QRect(510, 1, 121, 20))
        self.label_message_quantities.setObjectName("label_message_quantities")
        self.text_message_quantities = QtWidgets.QLabel(self.centralwidget)
        self.text_message_quantities.setGeometry(QtCore.QRect(630, 2, 121, 20))
        self.text_message_quantities.setObjectName("text_message_quantities")
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        self.label_message_quantities.setText(_translate("MainClientWindow", "Кол-во сообщений:"))
        self.text_message_quantities.setText(_translate("MainClientWindow", "0"))
